"""
URL configuration for Project_N project.
...
from django.urls import path, include #нужно еще импортировать include()

# Хост по умолчанию - 127.0.0.1:8000

urlpatterns = [
    path('admin/', admin.site.urls),
    # path() - встроенный метод в Django, для преобразрвания и получения пути из тела запроса
